      ...
      <div className="flex flex-col md:flex-row items-center md:items-start md:gap-20">
        ...
        <div className="flex flex-col items-center md:items-center mt-10 text-gray-600">
          ...
          <p className="my-10 max-w-lg">
            Lorem ipsum dolor sit amet consectetur adipisicing elit. Non ex quia
            harum accusantium magnam ipsam eos. Omnis, libero beatae provident
            excepturi fuga eius quibusdam adipisci amet, eveniet, cum esse enim.
          </p>
